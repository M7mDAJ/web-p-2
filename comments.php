...
if(isset($_POST['update_now'])){
   ...
   $verify_comment = $conn->prepare("SELECT * FROM `comments` WHERE id = ? AND comment = ? LIMIT 1");
...
<section class="comments">
   ...
   <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
      <div class="content">
         ...
         <a href="watch_video.php?get_id=<?= htmlspecialchars($fetch_content['id']); ?>">View content</a>
      </div>
